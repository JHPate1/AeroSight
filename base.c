...
#define WIFI_NAME "FBI SURVEILLANCE VAN #67"
#define WIFI_PW   "van67!"
#define BOUND     "----bound----"
...
{
    const char *html = "<html><head><title>Imager Home</title></head>"
        "<body style='background:#111;text-align:center;'>"
        "<h2 style='color:#eee;font-family:arial;'>Stream</h2>"
